...
patch(PosOrder.prototype, {
    ...
    getCustomerDisplayData(){
        ...
        const order = this.currentOrder; // Retrieve the current order
        const salesTax = order ? order.get_total_tax() : 0; // Calculate or retrieve the sales tax
        
        res.sales_tax = salesTax; // Add sales tax to the data
        return res
    }
})
